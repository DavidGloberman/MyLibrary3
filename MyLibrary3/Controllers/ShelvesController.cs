...
namespace MyLibrary3.Controllers
{
    public class ShelvesController : Controller
    {
        ...
        public ShelvesController(MyLibrary3Context context)
        {
            _context = context;
        }
        ...
        {
            var myLibrary3Context = _context.Shelf.Include(s => s.Library);
        ...
        public async Task<IActionResult> Create([Bind("Id,LibraryId,Height,Width")] Shelf shelf)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LibraryId,Height,Width")] Shelf shelf)
        {
            if (id != shelf.Id)
            {
                return NotFound();
